          ...
          <FadeIn>
            <div className="doc-info-card">
              ...
              <div className="doc-thumbs">
                <Image src="/doc_thumb_service.png" alt="サービス概要 - 年100万円の手取りアップ" width={460} height={259} loading="lazy" />
                <Image src="/doc_thumb_traditional.png" alt="従来とPLEX出張旅費制度の違い" width={460} height={259} loading="lazy" />
              </div>
