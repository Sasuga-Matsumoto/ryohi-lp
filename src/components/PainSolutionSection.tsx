      ...
      <div className="inner">
        ...
        <FadeIn>
          <div className="pain-cards">
            ...
            <div className="pain-card">
              <div className="pain-icon">!</div>
              <p>社会保険料の負担が年々増えているが<br />削減する手段がない</p>
            </div>
            <div className="pain-card">
              <div className="pain-icon">!</div>
        ...
        <FadeIn className="mid-cta">
          <div className="cta-group">
            <TrackedLink href="/contact/" className="btn btn-primary" eventParams={{ form_type: 'contact', cta_location: 'pain_solution' }}>お問い合わせ</TrackedLink>
          </div>
        </FadeIn>
      </div>
    </section>
